...
SCHEMA_PATH = Path('C:/Projects/Health Builders/clinical-cds-system/NCD-CDS-System/backend/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Projects\\Health Builders\\clinical-cds-system\\NCD-CDS-System\\backend\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma:
    patient: 'actions.PatientActions[models.Patient]'
    visit: 'actions.VisitActions[models.Visit]'
    followupschedule: 'actions.FollowUpScheduleActions[models.FollowUpSchedule]'
    ...
    def __init__(
        ...
        *,
        ...
        self.patient = actions.PatientActions[models.Patient](self, models.Patient)
        self.visit = actions.VisitActions[models.Visit](self, models.Visit)
        self.followupschedule = actions.FollowUpScheduleActions[models.FollowUpSchedule](self, models.FollowUpSchedule)
...
class Batch:
    patient: 'PatientBatchActions'
    visit: 'VisitBatchActions'
    followupschedule: 'FollowUpScheduleBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.patient = PatientBatchActions(self)
        self.visit = VisitBatchActions(self)
        self.followupschedule = FollowUpScheduleBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class VisitBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.VisitCreateInput,
        include: Optional[types.VisitInclude] = None
    ) -> None:
        self._batcher._add(
            method='create',
            model=models.Visit,
    ...
    def create_many(
        self,
        data: List[types.VisitCreateWithoutRelationsInput],
        *,
        skip_duplicates: Optional[bool] = None,
    ) -> None:
        if self._batcher._active_provider == 'sqlite':
    ...
    def delete(
        self,
        where: types.VisitWhereUniqueInput,
        include: Optional[types.VisitInclude] = None,
    ) -> None:
        self._batcher._add(
            method='delete',
    ...
    def update_many(
        self,
        data: types.VisitUpdateManyMutationInput,
        where: types.VisitWhereInput,
    ) -> None:
        self._batcher._add(
            method='update_many',
            model=models.Visit,
    ...
    def delete_many(
        self,
        where: Optional[types.VisitWhereInput] = None,
    ) -> None:
        self._batcher._add(
            method='delete_many',
            model=models.Visit,
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class FollowUpScheduleBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.FollowUpScheduleCreateInput,
        include: Optional[types.FollowUpScheduleInclude] = None
    ) -> None:
        self._batcher._add(
            method='create',
            model=models.FollowUpSchedule,
            arguments={
                'data': data,
                'include': include,
            },
    ...
    def create_many(
        self,
        data: List[types.FollowUpScheduleCreateWithoutRelationsInput],
        *,
        skip_duplicates: Optional[bool] = None,
    ) -> None:
        if self._batcher._active_provider == 'sqlite':
    ...
    def delete(
        self,
        where: types.FollowUpScheduleWhereUniqueInput,
        include: Optional[types.FollowUpScheduleInclude] = None,
    ) -> None:
        self._batcher._add(
            method='delete',
    ...
    def update(
        self,
        data: types.FollowUpScheduleUpdateInput,
        where: types.FollowUpScheduleWhereUniqueInput,
        include: Optional[types.FollowUpScheduleInclude] = None
    ) -> None:
        self._batcher._add(
    ...
    def upsert(
        self,
        where: types.FollowUpScheduleWhereUniqueInput,
        data: types.FollowUpScheduleUpsertInput,
        include: Optional[types.FollowUpScheduleInclude] = None,
    ) -> None:
        self._batcher._add(
            method='upsert',
    ...
    def update_many(
        self,
        data: types.FollowUpScheduleUpdateManyMutationInput,
        where: types.FollowUpScheduleWhereInput,
    ) -> None:
        self._batcher._add(
            method='update_many',
            model=models.FollowUpSchedule,
    ...
    def delete_many(
        self,
        where: Optional[types.FollowUpScheduleWhereInput] = None,
    ) -> None:
        self._batcher._add(
            method='delete_many',
            model=models.FollowUpSchedule,
